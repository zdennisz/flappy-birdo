...
const App = () => {
	...
	useEffect(() => {
		if (size.width) {
			if (
				((birdBottom < obsNegHeight + obsHeight + 30 ||
					birdBottom > obsNegHeight + obsHeight + obsGap - 30) &&
					obsLeft > size.width / 2 - 30 &&
					obsLeft < size.width / 2 + 30) ||
				((birdBottom < obsNegHeightTwo + obsHeight + 30 ||
					birdBottom > obsNegHeightTwo + obsHeight + obsGap - 30) &&
					obsLeftTwo > size.width / 2 - 30 &&
					obsLeftTwo < size.width / 2 + 30)
			) {
				gameOver();
			}
